 ...
 */
export const EmailConversationSummaryParams = zod.object({
  id: zod.coerce.number(),
});

export const EmailConversationSummaryBody = zod.object({
  recipientEmail: zod.string().describe("Email address to send the summary to"),
});

export const EmailConversationSummaryResponse = zod.object({
  success: zod.boolean(),
  message: zod.string(),
});
